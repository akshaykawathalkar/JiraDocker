...
define("jira/setup/setup-license", [
    'jira/util/formatter',
    'jira/util/data/meta',
    ...
    "jira/flag",
    "underscore"
], function(formatter, Meta, Deferred, $, Flag, _) {
    ...
    function generalErrorLogging() {
        showFormError(formatter.I18n.getText("setupLicense.error.unknown.title"), formatter.I18n.getText(
            "setupLicense.error.unknown.desc",
        ...
        function fillFormWithLicenseFromMac() {
            ...
            if (macLicense.trim())  {
                setTimeout(function() { Flag.showSuccessMsg(
                    formatter.I18n.getText("setupLicense.flag.title"),
                    formatter.I18n.getText("setupLicense.flag.text"),
                    { close : "auto" }
                )}, 1000);
