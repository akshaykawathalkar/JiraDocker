define("jira/setup/setup-finishing-notifications-view", ['wrm/context-path', "jquery", "backbone", "underscore"], function(wrmContextPath, $, Backbone, _) {
    ...
    return Backbone.Marionette.ItemView.extend({
        ...
        _navigateToJiraLockedPage: function(){
            ...
            window.location.href = wrmContextPath() + "/JiraLockedError";
        },
        ...
        triggerSetup: function(){
            ...
            this._jqXhrInFlight = $.ajax({
                ...
                url: wrmContextPath() + "/secure/SetupFinishing!triggerSetup.jspa",
                type: "POST",
                dataType: "json",
