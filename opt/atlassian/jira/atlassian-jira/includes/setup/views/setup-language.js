define("jira/setup/setup-language-view", [
    ...
    "backbone",
    "underscore"
], function(formatter, SingleSelect, Meta, wrmContextPath, $, Backbone, _) {
    return Backbone.Marionette.ItemView.extend({
        ...
        onButtonClick: function(){
            ...
            $.ajax({
                ...
                timeout: 5000,
                type: "POST",
                url: wrmContextPath() + "/secure/" + this.getCurrectActionName() + "!changeLanguage.jspa",
        ...
        pullInstalledLocales: function(){
            ...
            $.ajax({
                ...
                timeout: 5000,
                type: "GET",
                url: wrmContextPath() + "/secure/" + this.getCurrectActionName() + "!getInstalledLocales.jspa",
        ...
        pullLanguageTexts: function(){
            ...
            $.ajax({
                ...
                timeout: 5000,
                type: "GET",
                url: wrmContextPath() + "/secure/" + this.getCurrectActionName() + "!getLanguageTexts.jspa",
