...
AJS.$(function($){
    ...
    // Step 1 of 4 - setup-db.jsp
        ...
        AJS.$('input[name=databaseOption]').change(function() {
            ...
            var testbutton = AJS.$('#jira-setupwizard-test-connection');
            var externalFields = AJS.$('#setup-db-external');
        ...
        AJS.$('select[name=databaseType]').change(function(){
            ...
            var jdbcField = AJS.$("input[name='jdbcPort']");
            var schemaField = AJS.$("input[name='schemaName']");
    ...
    // Set 4 of 4 - setup-mail-notifications.jsp
        ...
        AJS.$('input[name=noemail]').change(function() {
            ...
            var notificationFields = AJS.$('#setup-notification-fields');
            var testButton = AJS.$('#jira-setupwizard-test-mailserver-connection');
    ...
    if (AJS.$('select[name=serviceProvider]').length > 0) {
        ...
        AJS.$("select[name=serviceProvider]").change((function(protocol) {
            return function() {
                ...
                var serverName = AJS.$("input[name=serverName]");
                var port = AJS.$("input[name=port]");
                var tls = AJS.$("input[name=tlsRequired]");
