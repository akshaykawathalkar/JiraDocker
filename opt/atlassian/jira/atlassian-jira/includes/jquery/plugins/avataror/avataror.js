...
jQuery.fn.avataror = function (options) {
    ...
    this.each(function () {
        ...
        avataror.img = $('<img alt="Avatar Source"/>');
        avataror.img.load(function () {
            ...
            avataror.imgwidth = avataror.img[0].naturalWidth;
            avataror.imgheight = avataror.img[0].naturalHeight;
