require([
    ...
    'jira/viewissue/init-comment-areas',
    'jira/viewissue/init-subtask-time-logging',
    'jira/viewissue/init-toggle-block',
    'jira/viewissue/init-custom-field-tabs',
    'jira/viewissue/init-view-issue-tabs'
], function() {
