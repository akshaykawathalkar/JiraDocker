...
define('jira/common/header', [
    ...
    'exports',
    'wrm/context-path'
], function(formatter, Messages, Issue, Events, jQuery, exports, contextPath) {
    var messageBuffer = {};
    ...
    var getProjectAdminLink = function(issueKey, section) {
        ...
        return formatter.format(
            ...
            contextPath() + "/plugins/servlet/project-config/" + projectKey + "/" + section
        );
    };
    ...
    exports.initialize = function() {
        Events.bind("QuickCreateIssue.sessionComplete", sessionCompleteCb = function (e, issues) {
            ...
            html += getEditMessage(formatter.I18n.getText(
                "jira.version.created.quick.create",
                getProjectAdminLink(issue.issueKey, "versions"),
                "</a>"
            ),
                    formatter.I18n.getText(
                        "jira.component.created.quick.create",
                        getProjectAdminLink(issue.issueKey, "components"),
                        "</a>"
                    ));
            showMessage(html);
        });
        ...
        if(issueApp()) {
            issueApp().on("issueEditor:saveSuccess", saveSuccessCb = function(saveDetails) {
                ...
                var msg = getEditMessage(formatter.I18n.getText("jira.version.created", getProjectAdminLink(issueKey, "versions"), "</a>"),
                        formatter.I18n.getText(
                            "jira.component.created",
                            getProjectAdminLink(issueKey, "components"),
                            "</a>"
                        ));
                showMessage(msg);
            });
