define('jira/admin/analytics', [
    'jira/project/projectdata',
    'jira/util/events',
    'jira/admin/admindata',
    'wrm/context-path',
    'jira/util/data/meta',
    'jquery',
    'jira/analytics',
    'jira/libs/parse-uri'
], function(projectData, Events, adminData, wrmContextPath, Meta, jQuery, analytics, parseUri) {
