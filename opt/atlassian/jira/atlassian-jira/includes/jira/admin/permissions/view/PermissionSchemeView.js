    ...
    return Backbone.View.extend({
        ...
        displayOperationFailureMessage: function (response) {
            ...
            // generic server error - for example: timeout
                ...
                jiraFlag.showWarningMsg(
                    formatter.I18n.getText('admin.permissions.feedback.unspecifiederror.title'),
                    formatter.I18n.getText('admin.permissions.feedback.unspecifiederror.description'),
                    {
                        close: 'manual'
                    }
                );
