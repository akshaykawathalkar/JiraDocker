define('jira/dialog/link-issue-dialog-factory', ['require'], function(require) {
    ...
    function loadIssueLinkContentResources() {
        return wrmRequire([
            'wrc!com.atlassian.jira.jira-issue-link-web-plugin:init-issuelink-web',
            'wrc!com.atlassian.jira.jira-issue-link-confluence-plugin:init-issuelink-confluence',
            'wrc!com.atlassian.jira.jira-issue-link-remote-jira-plugin:init-issuelink-jira'
        ]);
    }
    ...
    function createLinkIssueDialog(trigger) {
        ...
        return new FormDialog({
            ...
            content: function (ready) {
                ...
                jQuery.when(tabContentDeferred, remoteIssueLinksDeferred, loadUIResourcesDeferred)
                    .done(function (tabContent, linkTypes) {
