...
define('jira/tabs/tab-manager', [
    ...
    'jquery',
    'exports'
], function(Events, Types, Reasons, TabManagerUtil, $, exports) {
        ...
        exports.navigationTabs = (function () {
            ...
            var previousTab;    // {Object} we hold the previous tab here, just in case something goes wrong we can switch back
             ...
             */
            var runTabLoadEvent = function (hashMapID) {
             ...
             */
            var navigateToTab = function (tab, historyEvent, url) {
                var tabAnchor = $(tab).find("a");
                var id = tabUtil.getTabParamFromUrl(url);

                var populateTab = function (contentObj) {
             ...
             */
            var handleBrowserNavigation = function(tabParam){
