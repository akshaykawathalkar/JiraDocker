        ...
        ctx.find('.js-default-multi-group-picker').each(function () {
            ...
            new MultiSelect({
                ...
                ajaxOptions:  {
                    ...
                    formatResponse: showLabels ? GroupPickerUtil.formatResponseWithLabels :
                                                GroupPickerUtil.formatResponse
                }
            });
        });
    }
