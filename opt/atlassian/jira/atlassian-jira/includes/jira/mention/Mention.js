define('jira/mention/mention', [
    ...
    return Control.extend({
        ...
        textarea: function (textarea) {
            ...
            if (textarea) {
                ...
                this.layerController = new UncomplicatedInlineLayer({
                    offsetTarget: this._getOffsetTarget(),
                    allowDownsize: true,
         ...
         * @param selectedUserDisplayName The display name of the selected user.
         */
        _replaceCurrentUserName: function (selectedUserName, selectedUserDisplayName) {
