define('jira/searchers/element/due-date-searcher', [
    'jira/searchers/datesearcher/date-searcher-factory',
    'jira/skate'
], function(DateSearcherFactory, skate) {
    'use strict';
...
define('jira/searchers/element/resolved-date-searcher', [
    'jira/searchers/datesearcher/date-searcher-factory',
    'jira/skate'
], function(DateSearcherFactory, skate) {
    'use strict';
...
define('jira/searchers/element/created-date-searcher', [
    'jira/searchers/datesearcher/date-searcher-factory',
    'jira/skate'
], function(DateSearcherFactory, skate) {
    'use strict';
...
define('jira/searchers/element/updated-date-searcher', [
    'jira/searchers/datesearcher/date-searcher-factory',
    'jira/skate'
], function(DateSearcherFactory, skate) {
    'use strict';
...
define('jira/searchers/element/custom-date-searcher', [
    'jira/searchers/datesearcher/date-searcher-factory',
    'jira/skate'
], function(DateSearcherFactory, skate) {
    'use strict';
...
// Invoke immediately
require([
    'jira/searchers/element/due-date-searcher',
    'jira/searchers/element/resolved-date-searcher',
    'jira/searchers/element/created-date-searcher',
    'jira/searchers/element/updated-date-searcher',
    'jira/searchers/element/custom-date-searcher'
]);
