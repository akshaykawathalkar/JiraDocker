define('jira/wikipreview/wiki-preview', ['jira/util/formatter', 'wrm/context-path', 'jquery'], function(formatter, contextPath, jQuery) {
    ...
    return function wikiPreview(prefs, ctx)
    {
        ...
        var renderData = function(data)
        {
            ...
            changePreviewAccessibleTextTo(formatter.I18n.getText('renderer.preview.close', prefs.fieldId));
        ...
        return {
            ...
            showInput: function (e) {
                if (editField) {
                    ...
                    changePreviewAccessibleTextTo(formatter.I18n.getText('renderer.preview', prefs.fieldId));
                    scrollSaver.hide();
