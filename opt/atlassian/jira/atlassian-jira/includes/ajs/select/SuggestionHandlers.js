...
define('jira/ajs/select/suggestions/assignee-suggest-handler', [
...
], function(formatter, SelectSuggestHandler) {
    /**
    ...
    return SelectSuggestHandler.extend({
        ...
        formatSuggestions: function (descriptors, query) {
            ...
            if (query.length === 0) {
                descriptors[0].footerText(formatter.I18n.getText("user.picker.ajax.short.desc"));
            }
            return descriptors;
        }
    });
...
define('jira/ajs/select/suggestions/checkbox-multi-select-suggest-handler', [
    ...
    'jira/ajs/select/suggestions/suggest-helper',
    'jira/ajs/list/group-descriptor'
], function(formatter, SelectSuggestHandler, SuggestHelper, GroupDescriptor) {
    /**
...
define('jira/ajs/select/fetchers/static-descriptor-fetcher', ['jira/jquery/deferred', 'jira/lib/class', 'jquery'], function(Deferred, Class, jQuery) {
    /**
...
define('jira/ajs/select/fetchers/ajax-descriptor-fetcher', [
    ...
    'jquery',
    'underscore'
], function(logger, Deferred, Class, SmartAjax, jQuery, _) {
    /**
...
define('jira/ajs/select/fetchers/mixed-descriptor-fetcher', [
    ...
    'jquery',
    'underscore'
], function(Deferred, Class, AjaxDescriptorFetcher, jQuery, _) {
    /**
...
define('jira/ajs/select/fetchers/func-descriptor-fetcher', ['jira/jquery/deferred', 'jira/lib/class', 'jquery'], function(Deferred, Class, jQuery) {
    /**
