define('jira/attachment/inline-attach', [
    ...
    'jquery',
    'wrm/context-path'
], function(formatter, Class, XSRF, Navigator, jQuery, wrmContextPath) {
    /**
     ...
     */
    InlineAttach.FormPresenter.DEFAULT_URL = wrmContextPath() + "/secure/AttachTemporaryFile.jspa?decorator=none";
    ...
    InlineAttach.Text = (function() {
        ...
        return /** @lends InlineAttach.Text */{
            'upload.empty.file': formatter.I18n.getText("upload.empty.file"),
            'upload.too.big': formatter.I18n.getText("upload.too.big"),
            'upload.error.bad.response': formatter.I18n.getText("upload.error.bad.response"),
            'upload.error.unknown.status': formatter.I18n.getText("upload.error.unknown.status"),
            'upload.error.auth': formatter.I18n.getText("upload.error.auth"),
            'upload.error.badrequest': formatter.I18n.getText("upload.error.badrequest"),
            'upload.error.server': formatter.I18n.getText("upload.error.server"),
            'upload.cancel': formatter.I18n.getText("common.words.cancel"),
            //Jack.png - 2 secs left.
            'upload.file.remaining': formatter.I18n.getText("upload.file.remaining"),
            //Jack.png - waiting.
            'upload.file.waiting': formatter.I18n.getText("upload.file.waiting"),
            //Jack.png - stalled.
            'upload.file.stalled': formatter.I18n.getText("upload.file.stalled"),
            'upload.checkbox.title': formatter.I18n.getText("attachfile.attachment.checkbox.title"),
            'upload.xsrf.timeout': formatter.I18n.getText("attachment.error.xsrf.expired"),
            'upload.error.unknown': formatter.I18n.getText("attachment.error.unknown"),
            'upload.progress.title.waiting': formatter.I18n.getText("upload.progress.title.waiting"),
            'upload.progress.title.running': formatter.I18n.getText("upload.progress.title.running"),
            // 16.3/81.1MB, stalled.
            'upload.progress.title.unknown.stalled': formatter.I18n.getText("upload.progress.title.unknown.stalled"),
            //108 kB/s - 16.3/81.1 MB, 10 mins left
            'upload.progress.title.known': formatter.I18n.getText("upload.progress.title.known"),
            //108 kB/s - 16.3/81.1 MB, stalled.
            'upload.progress.title.known.stalled': formatter.I18n.getText("upload.progress.title.known.stalled"),
            'upload.kilobyte': formatter.I18n.getText("upload.kilobyte"),
            'upload.kilobyte.part': formatter.I18n.getText("upload.kilobyte.part"),
            'upload.megabyte': formatter.I18n.getText("upload.megabyte"),
            'upload.megabyte.part': formatter.I18n.getText("upload.megabyte.part"),
            'upload.gigabyte': formatter.I18n.getText("upload.gigabyte"),
            'upload.gigabyte.part': formatter.I18n.getText("upload.gigabyte.part"),
            'upload.seconds': formatter.I18n.getText("upload.seconds"),
            'upload.minutes': formatter.I18n.getText("upload.minutes"),
            'upload.hours': formatter.I18n.getText("upload.hours"),
            'upload.hours.minutes': formatter.I18n.getText("upload.hours.minutes"),
            'upload.bytes.per.second': formatter.I18n.getText("upload.bytes.per.second"),
            'upload.kilobytes.per.second': formatter.I18n.getText("upload.kilobytes.per.second"),
            'upload.megabytes.per.second': formatter.I18n.getText("upload.megabytes.per.second"),
            'upload.error.no.access': formatter.I18n.getText("upload.error.no.access"),
            'upload.error.does.not.exist': formatter.I18n.getText("upload.error.does.not.exist"),
            'upload.error.client.unknown': formatter.I18n.getText("upload.error.client.unknown"),
            'upload.error.too.many.files': formatter.I18n.getText("upload.error.too.many.files"),
            'upload.error.server.no.reply': formatter.I18n.getText("upload.error.server.no.reply"),
            ...
            tr: function(key) {
                if (arguments.length === 0) {
                    ...
                    args[0] = this[key];
                    return formatter.format.apply(AJS, args);
                } else {
                    return key;
                }
            },
            ...
            fileSize: function() {
                if (arguments.length === 0) {
                    ...
                    var key;
                    var b = InlineAttach.Text._classifySize(arguments[0]);
                    if (b.unit === kB) {
                        key = 'upload.kilobyte';
                    } else if (b.unit === MB) {
                        key = 'upload.megabyte';
            ...
            currentOutOfTotalSize: function(current, total) {
                var b = this._classifySize(total);
                var key;
                if (b.unit === kB) {
