AJS.test.require(["jira.webresources:inline-layer", "jira.webresources:ajs-underscorejs-amd-shim"], function() {
    ...
    var assert = {
        dropdown: {
            ...
            isOnLeftSide: function($field, $layer, message) {
            ...
            isOnRightSide: function($field, $layer, message) {
            ...
            isUnderneath: function($field, $layer, message) {
             ...
             */
            isNearBottom: function($layer, message) {
                var cushion = 0;
    ...
    test('can be constructed', function() {
        ...
        equal(typeof layer, 'object', 'should be an object');
    });
