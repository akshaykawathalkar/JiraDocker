define('jira/ajs/avatarpicker/avatar-store', [
    'jira/util/formatter',
    'jira/ajs/avatarpicker/avatar-util',
    'jira/ajs/avatarpicker/avatar-factory',
    'jira/ajs/ajax/smart-ajax',
    'jira/lib/class',
    'jquery'
], function(formatter, AvatarUtil, AvatarFactory, SmartAjax, Class, jQuery) {
    /**
        ...
        _buildCompleteUrl: function (url) {
            ...
            if (this.restParams) {
                ...
                for (var name in this.restParams) {
                    queryParams += formatter.format(
                        '&{0}={1}',
                        encodeURIComponent(name),
                        encodeURIComponent(this.restParams[name])
                    );
                }
