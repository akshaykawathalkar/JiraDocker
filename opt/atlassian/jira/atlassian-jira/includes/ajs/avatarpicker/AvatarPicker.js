define('jira/ajs/avatarpicker/avatar-picker', [
    'jira/util/logger',
    'jira/util/formatter',
    'jira/ajs/avatarpicker/avatar-picker/image-editor',
...
define('jira/ajs/avatarpicker/avatar-picker-factory', [
    'jira/util/formatter',
    'jira/ajs/avatarpicker/avatar-picker',
    'jira/ajs/avatarpicker/avatar-picker/image-editor',
    'jira/ajs/avatarpicker/avatar-manager',
    'jira/ajs/avatarpicker/avatar-manager-factory',
    'jira/ajs/avatarpicker/avatar',
    'jira/ajs/avatarpicker/avatar/sizes',
    ...
    exports.createUniversalAvatarPickerDialog = function createUniversalAvatarPickerDialog(options) {
        ...
        var projectAvatarDialog = new FormDialog({
            ...
            content: function (ready) {
                ...
                jQuery("<h2 />").text( options.title || formatter.I18n.getText('avatarpicker.project.title'))
    ...
    exports.createProjectAvatarPickerDialog = function createProjectAvatarPickerDialog(options) {
        var projectAvatarDialog = new FormDialog({
            ...
            content: function (ready) {
                ...
                jQuery("<h2 />").text(formatter.I18n.getText('avatarpicker.project.title'))
                    .appendTo($dialogWrapper);
    ...
    exports.createUserAvatarPickerDialog = function createUserAvatarPickerDialog(options) {
        ...
        var userAvatarDialog = new FormDialog({
            ...
            content: function (ready) {
                ...
                jQuery("<h2 />").text(formatter.I18n.getText('avatarpicker.user.title'))
                        .appendTo($dialogWrapper);
